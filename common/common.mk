...
CUDA_INSTALL_PATH ?= /usr/local/stow/cuda-10.1
...
SRCDIR     ?= 
ROOTDIR    ?= ..
ROOTBINDIR ?= ~/NVIDIA_CUDA-10.0_Samples/bin
BINDIR     ?= $(ROOTBINDIR)/$(OSLOWER)
ROOTOBJDIR ?= obj
LIBDIR     := ~/NVIDIA_CUDA-10.0_Samples/common/lib
COMMONDIR  := ~/NVIDIA_CUDA-10.0_Samples/common
